...
in Consul 1.1.0 but Consul 1.10.0 has removed the ability to set and reset the license using the CLI.
...
Usage: consul license <subcommand> [options] [args]
  ...
  This command has subcommands for viewing the Consul Enterprise license
